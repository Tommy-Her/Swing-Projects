 ...
 * @author vangu
 */
public class TommyGroceryList2 extends JPanel{
    
    private JList List;
    private DefaultListModel ListModel;
    private JTextField Item;
    
    public TommyGroceryList2(){
    ...
    private static void createAndShowGUI() {
        ...
        JComponent newContentPane = new TommyGroceryList2();
    ...
    class AddListener implements ActionListener, DocumentListener{
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(GroceryItem.equals("") || ListModel.contains(GroceryItem)){
                Toolkit.getDefaultToolkit().beep();
                return;
            }
            
            if(List.getSelectedIndex() == -1){
                ListModel.add(0, GroceryItem);
            ...
            ListModel.add(List.getSelectedIndex()+1, GroceryItem);
